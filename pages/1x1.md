...
features:
  ...
  footer_text: Your<span class="space"></span>life<span class="space"></span>will<span class="space"></span>never be<span class="space"></span>the<span class="space"></span>same
testimonials:
  image:
